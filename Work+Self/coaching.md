...
**Focus:** Managing anxiety, anger, and jealousy; establishing executive presence through calmness.

### Executive Presence & Anxiety (David)
* **The "Racing" Mind:** Addressed the tendency to be "amped up."
    * *Tactic:* 3 Long Breaths (Inhale/Exhale).
    * *Insight:* "It’s not about how much I’m throwing out there. It’s about how much they absorb."
* **Meeting Protocol:**
    * Observe the flow rather than staying in your head.
    * Determine who needs to be spoken to (Audio vs. Visual vs. Feeling types).
    * **Mantra:** "Don't overcomplicate it. Give them a ground on which to grow."

### Managing Up & Team Context (David)
* **Stakeholder Analysis (Bella):** Understanding her need for freedom/growth.
* **Communication Style:**
    * Use **Storytelling** to give context (people remember stories).
    * "Dripping water in a cave" strategy: Small, consistent updates rather than overwhelming dumps.
    * **Psychological Safety:** Allow team to see flaws to build trust.

### Emotional Triggers: Anger & Jealousy (David)
* **Anger:** Rooted in "not being heard" or needing validation.
    * *Reframing:* "Why should I care what they think?" / "Are the consequences worth it?"
* **Jealousy (The Competition):**
    * **Diagnosis:** Comparison is blocking clarity and readiness for the next role.
    * **Envy vs. Jealousy:** Envy is "I want that"; Jealousy is "I don't want them to have that."
    * **The Pivot:** Focus on self-work. "How is this blocking my opportunities to work on myself?"
    * **Radical Listening:** Stop filtering through the lens of competition.

---

## Q2: Strategic Relationships & Mental Models
**Focus:** Managing the skip-level (Rajat), the "Tai Chi" of conflict, and operational vs. strategic recognition.

### Cognitive Reframing (Rodney)
* **Victimhood vs. Agency:** Shifting from "looking for validation" to "calm collective."
* **The Restaurant Metaphor:** If a waiter brings the wrong dish, you don't spiral; you respectfully request the right one.
* **Cognitive Distortions:** Emotional Reasoning ("I feel it, so it's true") and All-or-Nothing thinking.
* **Tactic:** "What is the story I'm telling myself?" vs. "What if there is another story?"

### The "Tai Chi" of Office Politics (David)
* **Metaphor:** Absorb the opponent's energy and turn it back, rather than blocking it directly.
* **Application:** If pushed, stand on balance. Ask: "Have you considered this?"
* **Defusion:** Use listening to make people feel heard, preventing them from pushing harder.

### Managing the Skip-Level (Rajat)
* **User Experience (UX) Approach:** Treat the manager as a user. What is his UX of you?
* **Decoding the Skip:**
    * He is *not* a bottom-line/numbers guy.
    * He values: Why, How, Impact, and Big Picture.
* **Strategic vs. Tactical:** Shift conversation from 1,000 ft (tactics) to 10,000 ft (vision/career trajectory).

### Networking 1.0 (David)
* **The Shift:** Moving from transactional ("what can I get") to relational ("who are you").
* **Batting Average Model:**
    * 1 in 4: Home run.
    * 3 in 4: Neutral/Positive.
    * 1 in 4: Don't be persistent; take the hint.
* **Action:** Create A-List (Top Priority) and B-List targets.

---

## Q3: Identity, Authenticity & AI Strategy
**Focus:** Diversifying self-worth, authentic networking, and preparing for the AI shift.

### The Self-Worth Pie Chart (Rodney)
* **Concept:** If 90% of self-worth is tied to work performance, minor setbacks are devastating.
* **Goal:** Diversify the "pie" (Hobbies, Parenting, Health, Friends) to create emotional stability.
* **Identity Question:** "Who is James when he isn’t adding value?" (Learning to just *be*).

### Career Strategy: The AI Pivot (David)
* **The Gap:** Need to signal strategic thinking, not just execution.
* **The Pitch:** "What skills prepare me in the age of AI?"
* **Resources:** Potential Stanford Business School coursework or finding internal mentors.
* **Prep for VP (Jeff):** Signal value ("Here is what you want, here is how I plug in").

### Networking 2.0 (David)
* **Authenticity:** "Let's go bowling" mindset vs. transactional.
* **Serendipity:** Be curious about people with zero expectation of ROI.
* **Target:** Reach out to Victor Wong.

### Crisis Management (Homework)
* **Distraction Tolerance:** "Put the incident in a box, wrap it up, put it on a shelf."
* **Grounding:** Focus on physical sensations (feet on floor, temperature of drink) to exit the emotional spiral.

---

## Q4: Executive Polish & Future Planning
**Focus:** Communication brevity (stopping the ramble), strategic "planting seeds," and performance framing.

### Communication: The Rambling Index (Rodney)
* **The Issue:** Rambling increases with anxiety/stakes.
* **Anxiety/Rambling Scale:**
    * 90-100: Rambling with VIPs.
    * 40-50: Rambling with Coach (Rodney).
    * 10: Rambling with Wife/Kids.
* **The Fix:** "Authentic talking less." Smile and stop. Prepare talking points to avoid the urge to justify.

### Year-End Strategy & Promo Framing (David)
* **Operational Fires:**
    * *Decision Matrix:* "What do I have to drop to jump in?"
    * *Perspective:* Is it my problem, or my manager's problem?
* **Performance Review Framing:**
    * **Company Perspective:** "What's in it for the organization to promote me?" (Losses avoided + Future capabilities).
    * **Languaging:** Use "Leadership" instead of "Managing."
* **AI Positioning:**
    * Bring the *context* and *opportunity* of AI, not just technical code.
    * "Here is what I bring... Do we have a match?"

### Strategic Networking 3.0 (David)
* **Categorization:**
    * List A: Responds in 48 hours.
    * List B: Probable response.
    * List C: Everyone else.
* **Technique:** "Planting seeds and sprinkling." Connections are a gift that allow others to help.

---

## Q1 2026: Inner Foundation & Self-Regulation (The Tai Chi Base)
**Focus:** Building inner resilience as a first-class goal; managing the transition from "Catalytic Clarity" to "Boring Consistency"; handling Bowen's departure and performance review season.

### The Tai Chi Base (David/Rodney)
* **Core concept:** Not passivity — a practice of returning to base. When something hits you (reorg, lukewarm response, peer's success), the question is not "what does this mean about me?" It's "where is my base, and how quickly can I return to it?"
* **This became Goal 0** — the inner foundation that makes all outer goals possible.
* **Practice:** Visualize the Tai Chi base before high-stakes interactions. The millisecond reaction takes real practice.

### On Self-Regulation (Internal Operating Principles)
* **The pattern:** Uncertainty converts to analysis. The analysis feels productive but is avoidance.
...
* **Listen for:** "what's the timeline," "how much eng cost," feasibility concerns. That's the cue.

### On Managing Cross-Org Resistance (Applied to UPP Expansion)
...
* Keep escalation factual, not emotional.
* Dylan's feedback: "Be more aggressive and faster in escalating." Balance with "request" framing (never use the word "escalation" with Dylan).

### Behavioral Shift: Boring Consistency
* **Old Strategy:** Catalytic Clarity (High Heat, High Light)
* **New Strategy:** Boring Consistency (Low Heat, Steady Light)
* **Metric:** Zero instances of defensiveness or litigating the point
