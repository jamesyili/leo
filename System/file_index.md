...
| File | Description | Last updated |
|------|-------------|-------------|
| `pinsight.md` | Pinsight: milestones M1-M3, Reflex connection, partnerships, staffing | 2026-03-31 |
...
| `query_log.md` | Rolling log of NotebookLM queries + responses + actions | Unknown |
