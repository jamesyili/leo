...
**Source:** http://jalammar.github.io/hidden-states/
**Ingested:** 2026-04-02
...
[![](/images/explaining/colab-badge.svg)](https://colab.research.google.com/github/jalammar/ecco/blob/main/notebooks/Ecco_Output_Token_Scores.ipynb)
    

Evolution of the selected token

        ![](/images/explaining/logit_ranking_1.png)
...
The same visualization can then be plotted for an entire generated sequence, where each column indicates a
        ...
        ![](/images/explaining/sequence_111_rankings.PNG)
...
Visualizaing the evolution of the hidden states sheds light on how various layers contribute to generating this sequence as we can see in the following figure:
 ...
 [![](/images/explaining/ranking-eu-gpt2-thumb.png)](/images/explaining/ranking-eu-gpt2.png)
...
[![](/images/explaining/colab-badge.svg)](https://colab.research.google.com/github/jalammar/ecco/blob/main/notebooks/Ecco_Evolution_of_Selected_Token.ipynb)

Rankings of Other Tokens

        ![](/images/explaining/watch_keys_cabinet.png)
...
The key**s** to the cabinet ______ 
...
To answer correctly, one has to first determine whether we're describing the keys (possible subject #1) or the
        ...
        ![](/images/explaining/watch_key_cabinets.png)
...
The key to the cabinet**s** ______ 
...
This method can shed light on questions of bias and where they might emerge in a model. The following figures, for example, probe for the model's gender expectation associated with different professions:
        ...
        ![](/images/explaining/doctor.png)
        ![](/images/explaining/nurse.png)
...
[![](/images/explaining/colab-badge.svg)](https://colab.research.google.com/github/jalammar/ecco/blob/main/notebooks/Ecco_Comparing_Token_Rankings.ipynb)
...
You can proceed to do your own experiments using Ecco and the three notebooks in this article:
    ...
    [Output Token Scores](https://colab.research.google.com/github/jalammar/ecco/blob/main/notebooks/Ecco_Output_Token_Scores.ipynb)
...
You can report issues you run into at the Ecco's Github page. Feel free to share any interesting findings at the Ecco [Discussion](https://github.com/jalammar/ecco/discussions) board. I invite you again to read [Interpreting GPT the Logit Lens](https://www.lesswrong.com/posts/AcKRB8wDpdaN6v6ru/interpreting-gpt-the-logit-lens) and see the various ways the author examines such a visualization. I leave you with a small gallery of examples showcasing the responses of different models to different input prompts.
...
Gallery
        ...
        **Model:** DistilGPT2
        ...
        [![](/images/explaining/london_rankings.png)](london_rankings.png)
...
[ ![](/images/explaining/ranking-cordoba.png)](/images/explaining/ranking-cordoba.png)

**Model:** GPT2-Large
[![](/images/explaining/cordoba-gpt2.png)](/images/explaining/cordoba-gpt2.png)

**Model:** GPT2-XL
[![](/images/explaining/cordoba-gpt2xl.png)](/images/explaining/cordoba-gpt2xl.png)
...
**Input:** "The countires of the European Union are:\n1. Austria\n2. Belgium\n3.
        ...
        [![](/images/explaining/ranking-eu.png)](/images/explaining/ranking-eu.png)

        **Model:** GPT2-Large
[![](/images/explaining/ranking-eu-gpt2.png)](/images/explaining/ranking-eu-gpt2.png)

        **Model:** GPT2-XL
        [![](/images/explaining/ranking-eu-gpt2xl.png)](/images/explaining/ranking-eu-gpt2xl.png)
