...
## 2026-04-03 (late night) — NotebookLM integration, work-leo setup, Rekko pivot

**Done:**
- Authenticated NotebookLM MCP and registered 4 notebooks: Wes Kao Frameworks, Coaching Patterns, Decisive Framework, ML & AI System Design. Removed Improving Leo (not useful enough).
- Updated `notebooklm/notebooks.md` registry and CLAUDE.md notebook table to match
- Added proactive notebook consultation: expanded CLAUDE.md principle #10 with trigger patterns for all 4 notebooks + saved feedback memory
- Built work-leo setup for Pinterest work laptop: complete CLAUDE.md, work-only goals.md fork (stripped G0/coaching/personal), SETUP.md with exact file mappings. James deployed it same day — working on work laptop.
- Renamed all capitalized folders to lowercase (Work+Self, System, Learning, NotebookLM, SideProjects) + updated 22 files with path references
- Prepped Daniel conversation using Decisive Framework notebook — WRAP process, moat inventory, reality-test questions
- Debriefed Daniel conversation: Rekko pivoting to AI video engine. Updated `sideprojects/rekko.md` with decisions, parked ideas, next steps
- Produced next-steps summary for Rekko Claude Code

**Decisions:**
- 4 NotebookLM notebooks registered; Improving Leo removed
- work-leo: separate independent instance, one-time context copy from Leo, no persistent sync
- Rekko pivot: video generation pipeline is the hard-to-replicate moat. Audience-first, monetization later. ML models paused.
- All Leo folders now lowercase (consistency fix)

**Open:**
- Rekko: James needs to review Daniel's video pipeline codebase + draft 30-day plan
- Peptides e-commerce legality — deferred discussion with Daniel

**Next time:**
- Rekko: review Daniel's video pipeline, draft 30-day plan, share with Daniel
- Peptides legality follow-up with Daniel
