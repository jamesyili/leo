...
[gpt_ch04.py](https://github.com/rasbt/LLMs-from-scratch/blob/main/ch04/03_kv-cache/gpt_ch04.py): Self-contained code taken from Chapters 3 and 4 of my *Build a Large Language Model (From Scratch)* book to implement the LLM and run the simple text generation function

[gpt_with_kv_cache.py](https://github.com/rasbt/LLMs-from-scratch/blob/main/ch04/03_kv-cache/gpt_with_kv_cache.py): The same as above, but with the necessary changes made to implement the KV cache.
...
You can find these optimizations in the [gpt_with_kv_cache_optimized.py](https://github.com/rasbt/LLMs-from-scratch/blob/main/ch04/03_kv-cache/gpt_with_kv_cache_optimized.py) file.
