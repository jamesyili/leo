...
**Source:** https://www.interconnects.ai/p/why-nvidia-builds-open-models-with
**Ingested:** 2026-04-02
...
[Megatron-LM](https://arxiv.org/abs/1909.08053) (model parallelism framework that has become very popular again recently; alternatives:[ DeepSpeed](https://github.com/deepspeedai/DeepSpeed), PyTorch FSDP).[ ](https://github.com/NVIDIA/NeMo)
...
**Jul–Sep 2024 — Minitron / Nemotron-Mini:** First of their pruned models, pruned from 15B*.*[ Minitron-4B](https://huggingface.co/nvidia/Minitron-4B-Base) (base model), [Nemotron-Mini-4B-Instruct](https://huggingface.co/nvidia/Nemotron-Mini-4B-Instruct).[ Paper](https://arxiv.org/abs/2407.14679),[ code](https://github.com/NVlabs/Minitron).
...
**Mar–Jun 2025 — Nemotron-H:** First hybrid Mamba-Transformer models for inference efficiency*.*[ Paper](https://arxiv.org/abs/2504.03624),[ research page](https://research.nvidia.com/labs/adlr/nemotronh/),[ blog](https://developer.nvidia.com/blog/nemotron-h-reasoning-enabling-throughput-gains-with-no-compromises/). Models:[ 8B](https://huggingface.co/nvidia/Nemotron-H-8B-Base-8K),[ 47B](https://huggingface.co/nvidia/Nemotron-H-47B-Base-8K),[ 4B-128K](https://huggingface.co/nvidia/Nemotron-H-4B-Instruct-128K).

**May 2025 — Llama-Nemotron:** Efficient reasoning models built ontop of Llama (*still!). *[Paper](https://arxiv.org/abs/2505.00949).

**Sep 2025 — Nemotron Nano 2:** 9B hybrid for reasoning, continuing to improve in performance*.* 12B base on 20T tokens (FP8 training) pruned to 9B for post-training.[ Report](https://research.nvidia.com/labs/adlr/files/NVIDIA-Nemotron-Nano-2-Technical-Report.pdf), [V2 collection](https://huggingface.co/collections/nvidia/nvidia-nemotron-v2).

**Nov 2025 — Nemotron Nano V2 VL:** 12B VLM*. *[Report](https://research.nvidia.com/labs/adlr/files/NVIDIA-Nemotron-Nano-V2-VL-report.pdf).

**Dec 2025 — Nemotron 3:** Nano/Super/Ultra family, hybrid MoE, up to 1M context. Super/Ultra H1 2026. 
Nano: 25T tokens, 31.6B total / ~3.2B active, releases recipes + code + datasets.[ ](https://nvidianews.nvidia.com/news/nvidia-debuts-nemotron-3-family-of-open-models)Papers:[ White Paper](https://arxiv.org/abs/2512.20856),[ Technical Report](https://arxiv.org/abs/2512.20848). Models:[ Nano-30B-BF16](https://huggingface.co/nvidia/NVIDIA-Nemotron-3-Nano-30B-A3B-BF16),[ Base](https://huggingface.co/nvidia/NVIDIA-Nemotron-3-Nano-30B-A3B-Base-BF16),[ FP8](https://huggingface.co/nvidia/NVIDIA-Nemotron-3-Nano-30B-A3B-FP8).
