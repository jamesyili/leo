---
name: end-session
description: End a working session with Jarvis. Grills James on what was accomplished, captures decisions, and produces the session log entry. Use when wrapping up or saying goodbye.
user_invocable: true
---
