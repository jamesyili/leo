...
- **Key issues:** Doesn't create ideas, resists James's architecture suggestions, lacks decisiveness and communication skills. Dylan has lost trust over Group MP refusal.
- **Comp commitment:** James said he'd try for a bump by end of April. Decision: don't go to Dylan for this — tell Bella honestly the environment is tough.
